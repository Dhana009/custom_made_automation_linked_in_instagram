...
class topics:
    ...
    def alltopics(self):
        try:
            ...
            self.topics.set_index('sub_topics', inplace=True)
            return self.topics
    ...
    def select_topics(self,):
        try:
            self.one = input('select the first topic : ')
            self.two = input('select the first topic : ')
            self.three = input('select the first topic : ')
    ...
    def table(self):
        try:
            ...
            self.current_date = datetime.today().strftime("%d-%m-%y-%H-%M-%S")
